...
function exp_label_StationPNUDSourceRapport_2_eval_expression(context) {
    // 'St ' || "Stations-" || '\n' || 'Date ' || Obs || '\n' || 'Batterie ' || AlimBatt || '\n' || 'Regulateur ' || AlimRegul || '\n' || 'Panneau Sol ' || AlimPanSol || '\n' || 'Capteur ' || Capteur || '\n' || 'Datalogger ' || Datalogger

    var feature = context.feature;
    
    if (feature.properties) {
        return ((((((((((((((((((('St ' + feature.get('Stations-') ) + '\n') + 'Date ') + feature.get('Obs') ) + '\n') + 'Batterie ') + feature.get('AlimBatt') ) + '\n') + 'Regulateur ') + feature.get('AlimRegul') ) + '\n') + 'Panneau Sol ') + feature.get('AlimPanSol') ) + '\n') + 'Capteur ') + feature.get('Capteur') ) + '\n') + 'Datalogger ') + feature.get('Datalogger') );
    } else {
        return ((((((((((((((((((('St ' + feature.get('Stations-') ) + '\n') + 'Date ') + feature.get('Obs') ) + '\n') + 'Batterie ') + feature.get('AlimBatt') ) + '\n') + 'Regulateur ') + feature.get('AlimRegul') ) + '\n') + 'Panneau Sol ') + feature.get('AlimPanSol') ) + '\n') + 'Capteur ') + feature.get('Capteur') ) + '\n') + 'Datalogger ') + feature.get('Datalogger') );
    }
}